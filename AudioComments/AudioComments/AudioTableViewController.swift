...
class AudioTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let item = audioList[indexPath.row]
        cell.audioItem = item
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        print("add new sound? check")
        if segue.identifier == "addSound" {
            print("hello segue")
            guard let vc = segue.destination as? AudioRecorderController else {return}
            print("things are right")
            vc.delegate = self
        } else {
            print("NO")
        }
...
extension AudioTableViewController: AddItemDelegate {
